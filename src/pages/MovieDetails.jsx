...
const MovieDetails = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=YOUR_KEY&append_to_response=videos`)
      .then(res => res.json())
  ...
  return (
    <div className="movie-page">
      ...
      <div className="trailer">
        <iframe title="trailer" src={`https://www.youtube.com/embed/${movie.videos.results[0]?.key}`} />
      </div>
